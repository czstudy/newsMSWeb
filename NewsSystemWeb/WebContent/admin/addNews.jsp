...
<script charset="utf-8" src="<c:url value="/js/kindeditor-all.js"/>"></script>

<script charset="utf-8" src="<c:url value="/js/lang/zh-CN.js"/>"></script>
<script charset="utf-8" src="<c:url value="/js/plugins/code/prettify.js"/>"></script>
		...
		var editor1 = K.create('textarea[name="descipt"]', {
			cssPath : '<c:url value="/js/plugins/code/prettify.css"/>',
			...
			<div class="row">
				...
				<div class="col-lg-9">
					...
					<div class="bs-example" data-example-id="simple-table">
					    <form action="<c:url value='/NewsAction'/>" method="post">
					      <input type="hidden" name="method" value="add"/>
						<table class="table">
							<caption style="text-align:center;">添加新闻</caption>
							
							<tbody>

                                    <tr>
                                         <td>标题</td>
                                         <td><input type="text" style="width:90%; " name="title" value=""/></td>
                                    </tr>
                                     <tr>
                                         <td>副标题</td>
                                         <td><input type="text" style="width:90%"  name="otherTitle" value=""/></td>
                                    </tr>
							 <tr>
                                         <td>类别</td>
                                         <td><input type="text" name="categoryId" value="4"/></td>
                                    </tr>
							</tr>
							 <tr>
                                         <td>图像</td>
                                         <td><input type="text" name="imagePath" value="5"/></td>
                                    </tr>
									<tr>
